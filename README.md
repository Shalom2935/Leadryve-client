...
- Clear split between marketing routes and authenticated application routes
- Protected route handling with authentication state
- Zustand-based auth store with persistence
- API-driven mission dashboard behavior
- Zod validation for API response contracts
- Responsive UI built with reusable components
- Environment-based backend configuration
- Frontend tests covering validation, state management, and UI rendering
- Subdomain-aware application routing
...
- Add a typed API client abstraction
- Improve dashboard analytics
- Add richer mission and lead filtering
- Add more loading and empty states
- Expand accessibility testing
- Add CI workflow for linting, tests, and production builds
- Add screenshots and short product demo media to this README

---

## What This Repository Demonstrates

This repository demonstrates frontend engineering skills across product design, routing, state management, API integration, schema validation, and automated testing.

It is intended to show more than UI implementation: the codebase models a real SaaS-style workflow with authentication, onboarding, protected routes, mission management, backend integration, and testable application behavior.
